...
const About = (): JSX.Element => {
  ...
  return (
    <div
      ...
      className={`my-[100px] mx-auto flex items-center justify-between w-[90%] max-[1024px]:flex-col transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
    >
